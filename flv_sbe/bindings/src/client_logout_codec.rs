...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for ClientLogoutEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ClientLogoutEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a> Decoder<'a> for ClientLogoutDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
