...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for TradeBarEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TradeBarEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a> Reader<'a> for TradeBarDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TradeBarDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> TradeBarDecoder<'a> {
        ...
        pub fn price(&self) -> f32 {
            self.get_buf().get_f32_at(self.offset + 10)
        }
