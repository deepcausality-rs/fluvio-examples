...
impl From<u16> for MessageType {
    fn from(value: u16) -> Self {
        match value {
            ...
            204_u16 => MessageType::OHLCBar,
            205_u16 => MessageType::FirstOHLCBar,
            206_u16 => MessageType::LastOHLCBar,
...
impl Display for MessageType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            MessageType::OHLCBar => write!(f, "OHLCBar"),
            MessageType::FirstOHLCBar => write!(f, "FirstOHLCBar"),
            MessageType::LastOHLCBar => write!(f, "LastOHLCBar"),
